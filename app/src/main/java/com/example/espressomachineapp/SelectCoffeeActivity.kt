...
class SelectCoffeeActivity : AppCompatActivity(), View.OnClickListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("Current phone density: ${resources.displayMetrics.density}")
    ...
    override fun onClick(v: View) {
        if (v.id == esspressoBtn.id) {
            ...
            val CoffeeMakerActivityIntent = Intent(this, CoffeeMakerActivity::class.java)
            ...
            print("OTHERS")
            val Others = Intent(this, WaterMilkMakerActivity::class.java)
    ...
    private fun speakOut() {
        ...
        if (loadFlagData() == true)
            tts!!.speak(
                "Καφές! Τι ρόφημα θα θέλατε να πιείτε; Αν θέλετε να ακούσετε τις επιλογές, πείτε επιλογές! Αν θέλετε να πάτε στην προηγούμενη σελίδα, πείτε πίσω! Παρακαλώ, μιλήστε μετά τον ήχο!", //Hello. How could I serve you? Speak after the tone.
            ...
            tts!!.speak(
                "Coffee! Please tell me what would you like to drink or say choices to hear the possible choices .If you want to go back, say go back! Speak after the tone.", //Hello. How could I serve you? Speak after the tone.
                TextToSpeech.QUEUE_FLUSH,
                null,
                ""
            )
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == RQ_SPEECH_REC && resultCode == Activity.RESULT_OK) {
            ...
            if (word.toUpperCase() == "ΠΊΣΩ" || word.toUpperCase() == "GO BACK") {
                ...
                val CoffeeMakerActivityIntent = Intent(this, WaterMilkMakerActivity::class.java)
                saveData(coffeeSelected)
                startActivity(CoffeeMakerActivityIntent)
